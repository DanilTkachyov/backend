    ...
    <div class="form-container">
        ...
        <form method="POST" action="">
            <div class="input-group block">
                <input type="text" class="form-control" name="name" placeholder="Ваше имя: KUJO JOTARO" <?php if ($errors['name']) {
                                                                                                            print 'class="error"';
                                                                                                        } ?> value="<?php print $values['name']; ?>" />
            </div>
            <div class="input-group block">
                <input type="text" class="form-control" name="email" placeholder="Ваше email: jojo@mail.com" <?php if ($errors['email']) {
                                                                                                                    print 'class="error"';
            ...
            <div class="block">
                ...
                <select class="form-select form-select-lg mb-2" name="powers[]" multiple <?php if ($errors['powers']) {
                    ...
                    <option value="ora" <?php $arr = explode(',', $values['powers']);
                                        if ($arr != '') {
                    ...
                    <option value="emerald splash" <?php $arr = explode(',', $values['powers']);
                                                    if ($arr != '') {
                                                        foreach ($arr as $value) {
                    ...
                    <option value="sword" <?php $arr = explode(',', $values['powers']);
                                            if ($arr != '') {
                                                foreach ($arr as $value) {
                                                    if ($value == "sword") {
                                                        print 'selected';
